class Solution {
    public boolean exist(char[][] board, String word) {
        ...
        // time: each cell checked for start point -> O(mxn) m rows n columns
        // for each start point, 4 directions checked. if l is length of word -> O(4l)
        // -> O(4m.n.l)

        // space -> recursion stack depth -> as many letters in words -> O(l)
